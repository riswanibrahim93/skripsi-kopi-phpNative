    ...
    <div class="produk mt-4">
      <div id="card_produk">
        <div class="row" id="all_produk">
          <?php 
          $ketQuery = "SELECT * FROM `tabel_alternatif` WHERE `alternatif` LIKE '%$cari%'";
					$executeSat = mysqli_query($koneksi, $ketQuery);
          while($cari_alternatif=mysqli_fetch_array($executeSat)){ 
          ?>
            <div class="col-sm-3 mt-3">
              <div class="card" id="card" style="width: 18rem;" onclick="detail(<?php echo $cari_alternatif['id'];?>)">
                <div class="all" id="all">
                  <img src="img/produk/<?php echo $cari_alternatif['alternatif'];?>.jpg" class="card-img-top" alt="...">
                  <div class="card-body text-center mb-3">
                    <h6 class="card-title text-center font"><?php echo $cari_alternatif['alternatif']; ?> 200g Kopi Arabica</h6>
                    <h6 class="card-text text-center font font-rp" id="harga">Rp 
                      <?php 
                        $harga = $cari_alternatif['harga'];
                    ...
                    <a href="index.php?menu=detail&key=<?php echo $cari_alternatif['id'];?>" class="btn button-tampil center">Tampilkan Produk</a>
                  </div>
                </div>
              </div>
            </div>
