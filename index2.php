  ...
  <body>
        ...
        <div class="col-12 col-sm-10">
          <ul class="nav justify-content-center">
            <!-- <li class="nav-item-kanan">
              <a class="nav-link text-white ms-5 me-4" href="#">Garansi 2 tahun</a>
            </li>
            <li class="nav-item-kanan">
              <a class="nav-link text-white me-4" href="#">Gratis Ongkir*</a>
            </li>
            <li class="nav-item-kanan">
              <a class="nav-link text-white me-4" href="#">Produk Original</a>
            </li> -->
          </ul>
        </div>
        <div class="col-12 col-sm-2">
          <!-- <ul class="nav">
            <li class="nav-item-kiri">
              <a class="nav-link text-white" href="#">Download</a>
            </li>
            <li class="nav-item-kiri">
              <a class="nav-link text-white" href="#"><img class="logo-whatsapp" src="img/whatsapp.png"></a>
            </li>
            <li class="nav-item-kiri">
            ...
            <div class="row">
              <div class="col-sm-12">
                <ul class="nav justify-content-center">
                  ...
                  <li class="nav-item">
                    <!-- <a class="nav-link text-color" href="#"><img class="logo-kategori"src="img/kategori.png">Kategori</a> -->
                  </li>
                  <li class="nav-item item-search">
                    <div class="input-group search">
                      <span class="input-group-text search" id="basic-addon1"><img class="logo-loupe" src="img/loupe.png"></span>
                      <input type="text" class="form-control search input" placeholder="Cari kopi, alat kopi..." aria-label="Username" aria-describedby="basic-addon1">
                    </div>
                  </li>
                  <!-- <li class="nav-item me-2">
                    <a class="nav-link text-color me-4" href="#"><img class="logo-bag"src="img/shopping-bag.png"></a>
                  </li>
                  <li class="nav-item kosong">
                  </li> -->
                  <!-- <li class="nav-item">
                    <a class="nav-link text-color mt-1" href="#">Masuk</a>
                  </li>
                  <li class="nav-item">
                    <button type="button" class="button-daftar shadow">Daftar</button>
                  </li> -->
                </ul>
              </div>
            </div>
    ...
    <script type="text/javascript">
      ...
      function rekomendasi(){
        ...
        window.location.href = `index.php?menu=rekomendasi&notes=${flavor},${body},${sweetness},${acidity},${after_taste}`;
      }
    </script>
  </body>
</html>